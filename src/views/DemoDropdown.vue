<template>
  <div class="demo">
    ...
    <div class="demo__buttons">
      <sd-button icon-only rounded @click="dropdown = !dropdown">
        <sd-icon name="more_vert"/>
        <sd-dropdown v-model:active="dropdown">
      ...
      <sd-button rounded @click="dropdown2 = !dropdown2">
        <span>Dropdown</span>
